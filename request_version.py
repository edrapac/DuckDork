...
pass the exact y arg and make sure to encapsulate your dork in single quotes. PLEASE NOTE THAT EXACT SEARCHES WITH A DORK OFTEN FAIL ie allintext:"mark zuckerburg" but exact searches ie "mark zuckerberg" do not\n''',type=str)
